...
class NAFNetSR(nn.Module):
    ...
    '''
    def __init__(self, up_scale=4, width=96, num_blks=64, img_channel=3, drop_path_rate=0., drop_out_rate=0., fusion_from=-1, fusion_to=1000, dual=True):
        super().__init__()
...
class NAFNetSRLocal(Local_Base, NAFNetSR):
    def __init__(self, *args, train_size=(1, 6, 30, 90), fast_imp=False, **kwargs):
...
if __name__ == '__main__':
    model = NAFNetSR(up_scale=4)

    l = torch.rand((2, 3, 48, 96))
    r = torch.rand((2, 3, 48, 96))
